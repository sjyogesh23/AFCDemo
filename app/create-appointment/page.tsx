      ...
      <div className="space-y-6">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Schedule an appointment for your patient</p>
          </div>
        </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                type="submit"
                className="w-full"
                disabled={isSubmitting || !formData.patient || !formData.date || !formData.time || !formData.type}
              >
